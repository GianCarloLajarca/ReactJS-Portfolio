         ...
         <div className='slider-skills-title flex flex-col gap-4 mb-20 max-w-[45rem] mx-auto leading-8'>
            ...
            <Slider {...settings} className='px-20'>
                <div className='skills-card p-5 text-center bg-darkblue shadow-md'>
                    ...
                    <img src={`${baseImgUrl}/home/skills-1.png`} alt="" className='w-[7rem] h-[6rem] mx-auto object-fill'/>
                        <h3>C++ Programming</h3>
                ...
                <div className='skills-card p-5 text-center bg-darkblue shadow-md'>
                    <div className='flex flex-col gap-4 p-12'>
                    <img src={`${baseImgUrl}/home/skills-2.png`} alt="" className='w-[7rem] h-[6rem] mx-auto object-fill'/>
                ...
                <div className='skills-card p-5 text-center bg-darkblue shadow-md'>
                    <div className='flex flex-col gap-4 p-12'>
                    <img src={`${baseImgUrl}/home/skills-3.png`} alt="" className='w-[7rem] h-[6rem] mx-auto object-fill'/>
                        <h3>MS Access</h3>
                ...
                <div className='skills-card p-5 text-center bg-darkblue shadow-md'>
                    <div className='flex flex-col gap-4 p-12'>
                        <img src={`${baseImgUrl}/home/skills-4.png`} alt="" className='w-[7rem] h-[6rem] mx-auto object-fill'/>
                        <h3>MySQL</h3>
                        <p>Experienced in database management, I proficiently design, optimize, and maintain relational databases using MySQL and MS Access. 
                            With expertise in SQL querying and database administration, I ensure efficient data storage, retrieval, and management.</p>
                    </div>   
                ...
                <div className='skills-card p-5 text-center bg-darkblue shadow-md'>
                    <div className='flex flex-col gap-4 p-12'>
                    <img src={`${baseImgUrl}/home/skills-5.png`} alt="" className='w-[7rem] h-[6rem] mx-auto object-fill'/>
                        <h3>Networking</h3>
                ...
                <div className='skills-card p-5 text-center bg-darkblue shadow-md'>
                    <div className='flex flex-col gap-4 p-12'>
                        <img src={`${baseImgUrl}/home/skills-6.png`} alt="" className='w-[7rem] h-[6rem] mx-auto object-fill'/>
                        <h3>ReactJS</h3>
                ...
                <div className='skills-card p-5 text-center bg-darkblue shadow-md'>
                    <div className='flex flex-col gap-4 p-12'>
                        <img src={`${baseImgUrl}/home/skills-7.png`} alt="" className='w-[7rem] h-[6rem] mx-auto object-fill'/>
                        <h3>HTML</h3>
                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Odio laborum impedit natus accusantium eos doloribus ad facilis sunt nihil placeat porro expedita, ut non. Vero sunt dolores dignissimos nam doloremque officia, cumque quisquam quae totam?</p>
                    </div>   
                </div>
                <div className='skills-card p-5 text-center bg-darkblue shadow-md'>
                    <div className='flex flex-col gap-4 p-12'>
                        <img src={`${baseImgUrl}/home/skills-8.png`} alt="" className='w-[7rem] h-[6rem] mx-auto object-fill'/>
                        <h3>Tailwind CSS</h3>
                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Odio laborum impedit natus accusantium eos doloribus ad facilis sunt nihil placeat porro expedita, ut non. Vero sunt dolores dignissimos nam doloremque officia, cumque quisquam quae totam?</p>
                    </div>   
                </div>
                <div className='skills-card p-5 text-center bg-darkblue shadow-md'>
                    <div className='flex flex-col gap-4 p-12'>
                        <img src={`${baseImgUrl}/home/skills-9.png`} alt="" className='w-[7rem] h-[6rem] mx-auto object-fill'/>
                        <h3>SASS</h3>
                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Odio laborum impedit natus accusantium eos doloribus ad facilis sunt nihil placeat porro expedita, ut non. Vero sunt dolores dignissimos nam doloremque officia, cumque quisquam quae totam?</p>
                    </div>   
                </div>
